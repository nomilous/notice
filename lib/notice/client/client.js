...
var Connector, connectRejected, connector, createClient, defer, deferred, disconnected, existing, hostname, notifier, reservedMessage, terminal, testable, undefinedArg, _ref;
...
_ref = require('../errors'), terminal = _ref.terminal, reservedMessage = _ref.reservedMessage, undefinedArg = _ref.undefinedArg, existing = _ref.existing, connectRejected = _ref.connectRejected, disconnected = _ref.disconnected;
...
module.exports.client = function(config) {
  ...
  testable = local = {
    ...
    create: deferred(function(_arg, originName, opts, callback) {
      var already, client, error, notify, reject, resolve, socket;
