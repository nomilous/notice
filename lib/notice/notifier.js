...
module.exports.notifier = function(config) {
  ...
  testable = local = {
    ...
    create: function(originCode) {
      var notifier, sequence, type, _fn;
      ...
      notifier = {
        use: function(middleware) {
          if (typeof middleware === 'function') {
            return local.middleware[originCode][++sequence] = middleware;
          } else {
            if (!((middleware != null) && (middleware.title != null) && (middleware.fn != null))) {
              throw new Error("Notifier.use(middleware) requires middleware.title and middleware.fn");
            }
            return local.middleware[originCode][middleware.title] = middleware.fn;
          }
        }
      };
      _fn = function(type) {
