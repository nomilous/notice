  ...
  testable = local = {
    ...
    create: function(title, uuid) {
      ...
      traverse = function(capsule) {
        var middleware, middlewareFn, traversal;
        ...
        middleware = (function() {
          ...
          for (_i = 0, _len = mwBus.length; _i < _len; _i++) {
            middlewareFn = mwBus[_i];
            _results.push((function(middlewareFn) {
              return deferred(function(_arg) {
                ...
                try {
                  return middlewareFn(next, capsule, traversal);
                } catch (_error) {
                  error = _error;
                  return reject(error);
                }
