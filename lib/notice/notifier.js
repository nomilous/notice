...
var Defer, Message, Notifier, asResolver, deferred, isMiddleWare, message, pipeline, testable, _ref;
      ...
      notifier = {
        use: function(middleware) {
          if (typeof middleware === 'function') {
            return list[++regSequence] = middleware;
          } else {
            ...
            return list[middleware.title] = middleware.fn;
          }
        }
      };
      _fn = function(type) {
  ...
  create: function(origin, defaultFn) {
    ...
    notifier = function(title, descriptionOr, type, tenor) {
      ...
      return pipeline((function() {
        ...
        _ref1 = first.concat(middleware).concat(last);
        _results = [];
