...
var Defer, Local, Message, Notifier, asResolver, isMiddleWare, pipeline, taskFactory;
...
module.exports = Notifier = {
  create: function(origin, defaultFn) {
    ...
    api.task = function(title, opts) {
      return taskFactory.createTask(title, opts, notifier);
    };
