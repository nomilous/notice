...
var deferred, health, invalidAction, lifecycle, pipeline, testable, undefinedArg, v1, _ref, _ref1,
  __slice = [].slice;
...
module.exports.notifier = function(config) {
  ...
  testable = local = {
    ...
    create: function(title, uuid) {
      var first, keepErrors, last, list, localErrors, localMetrics, middlewareCount, mwBus, nfMetrics, notifier, reload, tooManyErrorsToKeep, traverse, type, _fn;
      if (uuid == null) {
        uuid = v1();
      }
      ...
      local.notifiers[title] = notifier = {
        ...
        force: function(opts, fn) {
          ...
          if (!((opts != null) && (opts.title != null))) {
            throw undefinedArg('opts.title', 'use(opts, middlewareFn)');
          }
          ...
          if (existing == null) {
            throw invalidAction('force(opts, middlewareFn)', 'cannot insert new middleware');
          }
