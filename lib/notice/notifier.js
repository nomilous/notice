  ...
  testable = local = {
    ...
    create: function(title, uuid) {
      ...
      traverse = function(capsule) {
        var definition, middleware, traversal;
        ...
        middleware = (function() {
          ...
          for (_i = 0, _len = mwBus.length; _i < _len; _i++) {
            definition = mwBus[_i];
            _results.push((function(definition) {
              return deferred(function(_arg) {
                ...
                type = definition.type, title = definition.title, fn = definition.fn;
                next = function() {
                ...
                try {
                  return fn(next, capsule, traversal);
                } catch (_error) {
                  error = _error;
                  return reject(error);
                }
