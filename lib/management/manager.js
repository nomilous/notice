...
module.exports.manager = function(config) {
  ...
  testable = local = {
    ...
    middleware: function(action, hub, slot, body, response, statusCode) {
    ...
    insertMiddleware: function(hub, slot, middleware) {},
    upsertMiddleware: function(hub, slot, middleware) {}
  };
  local.routes = {
    '/about': {
    ...
    '/v1/hubs/:uuid:/middlewares': {
      ...
      handler: function(_arg, _arg1, response, statusCode) {
        var authenticEntity, body, hubuuid, method, nothing, notifier;
        hubuuid = _arg[0], nothing = _arg[1], authenticEntity = _arg[2];
        method = _arg1.method, body = _arg1.body;
        if (statusCode == null) {
          statusCode = 200;
        }
        console.log({
    ...
    '/v1/hubs/:uuid:/middlewares/:slot:': {
      ...
      handler: function(_arg, _arg1, response, statusCode) {
        var authenticEntity, body, hubuuid, method, middlewares, notifier, slot;
  ...
  _ref = start(opts, local.requestHandler = authenticated(function(authenticEntity, request, response) {
    ...
    return request.on('end', function() {
      ...
      try {
        _ref = path.match(/(.*)\/(.*)\/(.*)\/(.*)\/(.*)\/(.*)/), match = _ref[0], version = _ref[1], base = _ref[2], uuid = _ref[3], nested = _ref[4], slot = _ref[5], action = _ref[6];
        return local.routes["" + version + "/" + base + "/:uuid:/" + nested + "/:slot:/" + action].handler([uuid, slot, authenticEntity], request, response);
      } catch (_error) {}
      try {
        _ref1 = path.match(/(.*)\/(.*)\/(.*)\/(.*)\/(.*)/), match = _ref1[0], version = _ref1[1], base = _ref1[2], uuid = _ref1[3], nested = _ref1[4], slot = _ref1[5];
